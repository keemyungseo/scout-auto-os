#!/usr/bin/env python3
"""Run Short Constitution Research V1."""
...
from scout_auto_os.engine.research.short_constitution.runner import ShortConstitutionRunner
...
def main():
    ...
    runner = ShortConstitutionRunner(
        Path(args.data_dir),
        pkg_root=PKG,
    ...
    if result is None:
        sys.exit(1)
    print(result["decision"]["q5_completeness_score"])
    sys.exit(0)
